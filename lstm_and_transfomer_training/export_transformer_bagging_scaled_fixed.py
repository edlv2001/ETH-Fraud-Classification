...
from keras.src.layers import Input, Dense, Dropout, LayerNormalization, MultiHeadAttention, GlobalAveragePooling1D
...
# Definir una función para crear el modelo Transformer
...
# Exportar los modelos con pickle
with open('transformer_ensemble_models.pkl', 'wb') as f:
